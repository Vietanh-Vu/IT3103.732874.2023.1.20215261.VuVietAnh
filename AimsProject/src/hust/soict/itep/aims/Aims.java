...
public class Aims {
    ...
    public static void main(String[] args) {
        ...
        CompactDisc cd4 = new CompactDisc(4, "CD Title 4", "Jazz", 24.99f, "N/A", 150, "Artist 4");

        DigitalVideoDisc dvd1 = new DigitalVideoDisc(5, "DVD Title 1", "Action", "Director 1", 120, 15.99f);
        DigitalVideoDisc dvd2 = new DigitalVideoDisc(6, "DVD Title 2", "Comedy", "Director 2", 90, 19.99f);
        DigitalVideoDisc dvd3 = new DigitalVideoDisc(7, "DVD Title 3", "Drama", "Director 3", 110, 12.99f);
        DigitalVideoDisc dvd4 = new DigitalVideoDisc(8, "DVD Title 4", "Sci-Fi", "Director 4", 150, 24.99f);
    ...
    private static void addMediaToStore() {
        ...
        switch (mediaType.toUpperCase()) {
            case "CD":
                ...
                CompactDisc cd = new CompactDisc(id, title, category, cost, directorCD, lengthCD, artist);
                store.addMedia(cd);
                break;
            ...
            case "DVD":
                ...
                DigitalVideoDisc dvd = new DigitalVideoDisc(id, title, category, directorDVD, lengthDVD, cost);
                store.addMedia(dvd);
                break;
